            ...
            try {
                for (const { reviewers, internal_reviewers: internalReviewers, usernames } of this.config.groups) {
                    ...
                    if (reviewersToRequest) {
                        selected = selected.concat(this.pickRandom(usernames, reviewersToRequest, selected.concat(author)));
                    }
                }
            }
            catch (error) {
...
const runLottery = (octokit_1, config_1, ...args_1) => __awaiter(void 0, [octokit_1, config_1, ...args_1], void 0, function* (octokit, config, env = {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const core = __importStar(__nccwpck_require__(2186));
const lottery_1 = __nccwpck_require__(5456);
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield (0, lottery_1.runLottery)(new rest_1.Octokit({ auth: token, baseUrl: userBaseUrl }), config);
        }
        catch (error) {
            core.setFailed(error.message);
        }
